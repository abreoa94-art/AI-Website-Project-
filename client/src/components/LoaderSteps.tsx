...
const steps = [
    {icon: ScanLineIcon, label: 'Analyzing your request...', description: 'Understanding your requirements and planning the website structure.'},
    {icon: SquareIcon, label: 'Generating Layout Structure...', description: 'Creating the basic layout and structure of your website.'},
    {icon: TriangleIcon, label: 'Assembling UI components...', description: 'Applying styles, colors, and themes to match your brand.'},
    {icon: CircleIcon, label: 'Finalizing your website...', description: 'Ensuring responsiveness and optimizing for performance.'},
]
...
const LoaderSteps = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
      ...
      {/* step - label - fade using transtion only ( no invisible start) */}
      <p key={current} className='mt-8 text-lg font-light text-white/90 traking-wide transition-all duration-700 ease-in-out opacity-100'>{steps[current].label}</p>
